...
import com.desarollobluetooth.fragments.ConnectionSettingsFragment
import ru.airmasters.airstd_full.fragment.ServiceListFragment
import ru.airmasters.airstd_full.fragment.CustomizationFragment
import ru.airmasters.airstd_base.observers.Observer
import ru.airmasters.airstd_base.observers.ObserverManager
import kotlin.collections.HashMap

class MainActivity : AppCompatActivity(), ConnectionSettingsFragment.OnFragmentInteractionListener, Observer {
    ...
    fun initPage() {
        updateFragment("CustomizationFragment");
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragments["CustomizationFragment"] = CustomizationFragment.newInstance("","", sharedPreference)
