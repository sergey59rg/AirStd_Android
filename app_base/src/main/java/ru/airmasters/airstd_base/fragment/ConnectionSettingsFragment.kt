...
import ru.airmasters.airstd_base.DeviceAdapter
import ru.airmasters.airstd_base.R
...
//        startScan()
    ...
    private fun textSearch(){
        ...
        if(context != null) {
            beak_txt?.setTextColor(ContextCompat.getColorStateList(context!!, R.color.colorPrimaryText))
        }
    }
    ...
    private fun textConnected(){
        ...
        if(context != null) {
            beak_txt?.setTextColor(ContextCompat.getColorStateList(context!!, R.color.colorSecondaryText))
        }
    }
